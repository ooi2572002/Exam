...
<%
    ...
    if (entYearStr != null && !entYearStr.isEmpty() &&
        ...
        TestListSubjectDao subjectDao2 = new TestListSubjectDao();
        testList = subjectDao2.filter(entYear, classNum, subjectCd);
        ...
        <section class="me-4">
            ...
            <div class="border mx-3 mb-3 p-3 rounded">
                ...
                <form method="get" action="TestListStudentExecute.action">
                    <input type="hidden" name="studentNo" value="<%= studentNo != null ? studentNo : "" %>">
